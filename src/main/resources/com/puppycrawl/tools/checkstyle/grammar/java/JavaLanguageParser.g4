...
stringTemplate
    : STRING_TEMPLATE_BEGIN
      ...
      ( EMBEDDED_EXPRESSION_BEGIN expr? EMBEDDED_EXPRESSION_END)?
       stringTemplateMiddle* STRING_TEMPLATE_CONTENT? STRING_TEMPLATE_END
    ;

stringTemplateMiddle
    : STRING_TEMPLATE_MID STRING_TEMPLATE_CONTENT ( EMBEDDED_EXPRESSION_BEGIN expr? EMBEDDED_EXPRESSION_END)?
    ;
